...
QT_MOC_LITERAL(16, 14), // "sigUpdateSever"
QT_MOC_LITERAL(31, 0), // ""
QT_MOC_LITERAL(32, 19), // "sigClientDisconnect"
QT_MOC_LITERAL(52, 15), // "slotReceiveData"
QT_MOC_LITERAL(68, 22) // "slotClientDisconnected"

    },
    "TcpClientSocket\0sigUpdateSever\0\0"
    "sigClientDisconnect\0slotReceiveData\0"
...
static const uint qt_meta_data_TcpClientSocket[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       3,    1,   43,    2, 0x06,    4 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       4,    0,   46,    2, 0x0a,    6 /* Public */,
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigUpdateSever((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->sigClientDisconnect((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->slotReceiveData(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::sigUpdateSever)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::sigClientDisconnect)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientSocket::sigUpdateSever(QString _t1, int _t2)
{
...
// SIGNAL 1
void TcpClientSocket::sigClientDisconnect(int _t1)
{
